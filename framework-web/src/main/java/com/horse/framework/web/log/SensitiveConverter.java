package com.horse.framework.web.log;
 ...
 *          4 邮箱地址
 *      使用方法
 *          需要在业务系统的日志配置文件中增加 转换规则配置: <conversionRule conversionWord="m" converterClass="com.horse.framework.web.log.SensitiveConverter"> </conversionRule>
 *
 * @author Gopal.pan
 * @version 1.0.0
 */
