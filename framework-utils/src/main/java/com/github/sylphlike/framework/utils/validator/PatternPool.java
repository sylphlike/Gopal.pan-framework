...
public class PatternPool {
    ...
    /** 特殊符号 */
    public static final Pattern  SPECIAL_CHARACTER_VALIDATE_WEAK = Pattern.compile("^[^`~!@#$%^&*=|{}''//[//].<>/?~！@#￥%……&*——|{}‘；：”“’]*$");
    public static final Pattern  SPECIAL_CHARACTER_VALIDATE_MIN = Pattern.compile("^[^`~!@#$%^&*+=|{}':;',//[//].<>/?~！@#￥%……&*——+|{}【】‘；：”“’。，、？]*$");
    public static final Pattern  SPECIAL_CHARACTER_VALIDATE_FORCED = Pattern.compile("^[^`~!@#$%^&*()+=|{}':;',//[//].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“’。，、？]*$");
